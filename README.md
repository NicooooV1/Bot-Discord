...
- poste dans `#logs-vpn` (Lock R820 : le VPN est un service du R820 ; seuls les journaux transverses type #logs-2fa vont en Archive) un événement par transition (connexion, fin de session, changement d'endpoint,
